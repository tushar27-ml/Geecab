...
<!-- Mirrored from html.themexriver.com/industrio/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Dec 2022 16:06:30 GMT -->
<head>
    <meta charset="UTF-8" />
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="single-team-style-one text-center">
                        <div class="img-box">
                            ...
                            <div class="name-box">
                                <div class="inner">Meagan Lindorf</div><!-- /.inner -->
                            </div><!-- /.name-box -->
                        </div><!-- /.img-box -->
                        <div class="text-box">
                            <p>Plumber</p>
                ...
                <div class="col-md-3">
                    <div class="single-team-style-one text-center">
                        <div class="img-box">
                            ...
                            <div class="name-box">
                                <div class="inner">Jalisa Secundo</div><!-- /.inner -->
                            </div><!-- /.name-box -->
                        </div><!-- /.img-box -->
                        <div class="text-box">
                            <p>Constractor</p>
                ...
                <div class="col-md-3">
                    <div class="single-team-style-one text-center">
                        <div class="img-box">
                            ...
                            <div class="name-box">
                                <div class="inner">Marcella Polera</div><!-- /.inner -->
                            </div><!-- /.name-box -->
                        </div><!-- /.img-box -->
                        <div class="text-box">
                            <p>Founder & CEO</p>
                ...
                <div class="col-md-3">
                    <div class="single-team-style-one text-center">
                        <div class="img-box">
                            ...
                            <div class="name-box">
                                <div class="inner">Sal Rebell</div><!-- /.inner -->
                            </div><!-- /.name-box -->
                        </div><!-- /.img-box -->
                        <div class="text-box">
                            <p>Constractor</p>
                ...
                <div class="col-md-3">
                    <div class="single-team-style-one text-center">
                        <div class="img-box">
                            <img src="img/team-1-5.png" alt="Awesome Image"/>
                            <div class="name-box">
                                <div class="inner">Ashlie Pavelec</div><!-- /.inner -->
                            </div><!-- /.name-box -->
                        </div><!-- /.img-box -->
                        <div class="text-box">
                            <p>Plumber</p>
                ...
                <div class="col-md-3">
                    <div class="single-team-style-one text-center">
                        <div class="img-box">
                            <img src="img/team-1-6.png" alt="Awesome Image"/>
                            <div class="name-box">
                                <div class="inner">Anisha Burnette</div><!-- /.inner -->
                            </div><!-- /.name-box -->
                        </div><!-- /.img-box -->
                        <div class="text-box">
                            <p>Constractor</p>
                ...
                <div class="col-md-3">
                    <div class="single-team-style-one text-center">
                        <div class="img-box">
                            <img src="img/team-1-7.png" alt="Awesome Image"/>
                            <div class="name-box">
                                <div class="inner">Merrilee Giffee</div><!-- /.inner -->
                            </div><!-- /.name-box -->
                        </div><!-- /.img-box -->
                        <div class="text-box">
                            <p>Founder & CEO</p>
                ...
                <div class="col-md-3">
                    <div class="single-team-style-one text-center">
                        <div class="img-box">
                            <img src="img/team-1-8.png" alt="Awesome Image"/>
                            <div class="name-box">
                                <div class="inner">Barrie Forbs</div><!-- /.inner -->
                            </div><!-- /.name-box -->
                        </div><!-- /.img-box -->
                        <div class="text-box">
                            <p>Constractor</p>
...
<!-- Mirrored from html.themexriver.com/industrio/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Dec 2022 16:06:31 GMT -->
</html>