...
<body>
  ...
  <main>
    ...
    <form action="../includes/addpost.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Created_by</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" name = "post_image[]" accept="image/*" type="file" id="formFile" required>
                  </div>
                </div>
                <div class="row mb-3">
